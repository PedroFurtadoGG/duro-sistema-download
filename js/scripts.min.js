...
if(/[^\x00-\x80]/.test(oFxNcL+oFyNcL)&&oFxNcL.localeCompare){var comp=oFxNcL.localeCompare(oFyNcL);return comp/Math.abs(comp);}
...
function activeMenu(){var href_=location.pathname.split('/').pop();var page=href_.split(".")[0];$('li a[href="'+page+'.php"]').addClass('active');if(page=='index'||page===''){page='home';$('li a[href="index.php"]').addClass('active');}
...
(function(){if(typeof($('#mobileMenu'))!=='undefined'&&$('#mobileMenu')!==null){var waitForFinalEvent=function(){var b={};return function(c,d,a){a||(a="I am a banana!");b[a]&&clearTimeout(b[a]);b[a]=setTimeout(c,d);};}();dataViewport();$(window).resize(function(){waitForFinalEvent(function(){dataViewport();},0);});}}());function dataViewport(){if($(window).width()>=1024){$('html').attr('data-viewport','desktop');}
if($(window).width()<1120&&$(window).width()>=1024){$('html').attr('data-viewport','default');}
if($(window).width()<1024&&$(window).width()>=768){$('html').attr('data-viewport','tablet');}
if($(window).width()<768&&$(window).width()>=320){$('html').attr('data-viewport','mobile');}
if($(window).width()<320){$('html').attr('data-viewport','mobile-s');}}
